...
<div style="text-align: center;">
    <img src="../../assets/img/usb/main.PNG" width="300" alt="">
</div>
<br>
...
La norme USB est devenu LA NORME pour connecter des dispositifs aujourd'hui. Et même si le hub, et la conception même de l'USB peuvent arbitrer et/ou intégrer plusieurs dispositifs à la fois, ça reste tout de même du série.
</div>
> D'un point A... <br>
> A un point B. <br>

<div style="text-align: justify">
Simple, précis. Mais ça remonte déjà aux années 60, avec le le fameux <i>RS232</i>, issu du consortium entre plusieurs grosses boîtes américaines; citons <b>IBM</b>, <b>Motorola</b>, <b>TexasInstruments</b>, <b>General Electrics</b>, <b>Intel</b>.
<br> <br>
<details>
	...
	Un jour je parlerai de l'essor de l'impérialisme américain à base de corporatisme tech' 😏 </p>
</details>
<br>
...
<div style="display: flex; align-items: flex-start; text-align: justify;">
    <div style="flex: 1;">
        <br>
        <p>
            Le truc a été repris, nottament avec le PS/2 d'<b>IBM</b> qui restera à jamais dans nos coeurs avec son design rond, lila et vert pomme (2 connecteurs avec 6 pins chacun). Y avait aussi <b>Apple</b> et son <i>FireWire</i>, en 6 ou 4 broches, rien de sensationnel cependant.
        </p>
        <p>
            Dans le même temps sont arrivés des... trucs... parallèles qu'ils disent:
            <ul>
                <li> Le <b>Centronix</b>, de la boite (emoji USA) du même nom, et son connecteur à 36 pins... puis son évolution en ECP et EPP (Parallel), avec 25 pinoches. </li>
                <li> Le <b>SCSI</b>, venu d'un consortium concurrent... Toujours des américains. Ils ont mis 50 pins les bougres. </li>
            </ul>
        </p>
    </div>
    <div style="flex: 0 0 auto; margin-left: 20px;">
        <img src="../../assets/img/usb/parallel.PNG" style="width: 250px;">
    </div>
</div>
...
<div style="text-align: center;">
    <img src="../../assets/img/usb/usb_if.PNG" width="300" alt="">
</div>
<br>
...
<div style="display: flex; align-items: flex-start; text-align: justify;">
    <div style="flex: 1;">
        ...
        <details>
            ...
            <img src="../../assets/img/usb/usb_cdc.PNG" style="width: 250px;">
        </details>
    </div>
    <div style="flex: 0 0 auto; margin-left: 20px;">
      <img src="../../assets/img/usb/usb_class.PNG" alt="" style="float: right; margin-left: 20px; width: 110px;">
    </div>
</div>
...
<div style="display: flex; align-items: flex-start; text-align: justify;">
    <div style="flex: 1 1 100px;">
        <img src="../../assets/img/usb/usb_endpoints.PNG" alt="">
    </div>
    <div style="flex: 1; margin-left: 10px;">
        <p style="margin-top: 0;">
            ...
            <li> <i>Bulk</i>, avec correction d'erreur, et en grande quantité.</li>
            <li> <i>Interrupt</i>, rapide, mais en petite quantité.</li>
            <li> <i>Isochronous</i>, temps-réel, peu importe l'intégrité.</li></ul>
        </p>
    </div>
</div>
<br>
...
<p style="text-align: justify;">
    ...
    référence précedemment. C'est le fait d'intégrer plusieurs dispositifs à la fois dans un même dispositif. Maintenant que tu sais ce qu'est une classe, j'imagine que tu vois l'idée. <br>
...
<p style="text-align: justify;">
    Si tu tapes "<b>BadUSB</b>" sur google, rapidement tu verras parler d'HID (<i>jusque là toi devoir comprendre</i> 😘), de payloads (les trucs envoyés par le HID), de <b>Rubber Ducky</b> (un utilitaire pour générer des payloads), mais aussi <b>et surtout</b> du chip USB 2.0 <b>Phison 2303</b>...
</p>
<p style="text-align: justify;">
    Mais pourquoi ce chip en particulier? Pour [ce repository github](https://github.com/flowswitch/phison) qui fournit toutes les instructions pour reprogrammer la flash du micro, ainsi qu'un firmware custom pour envoyer des payloads pré-programmés en tant que dispositif HID.
</p>
<div style="text-align: center;">
    <img src="../../assets/img/usb/phison2303.PNG" width="500" alt="">
</div>
<br>
<p style="text-align: justify;">
    <b>Alors</b> j'ai mis une petite tête de mort, parce que le chip n'est plus en production, et la documentation introuvable (<b>la datasheet ne suffit JAAAAAMAAAAIS</b>). Ca aurait été vraiment cool de pouvoir regarder comment c'est monté derrière, mais déjà on peut affirmer que: 
    <ul>
...
<div style="display: flex; align-items: flex-start; text-align: justify;">
    <div style="flex: 1 1 100px;">
        <img src="../../assets/img/usb/datasheet.PNG" alt="">
    </div>
...
<p style="text-align: justify;">
    Franchement, connaître la petite histoire m'intéresserait beaucoup (et voir la documentation aussi). Si j'ai du temps à perdre, j'irai me perdre sur le moteur de recherche chinois à voir si y a pas une histoire croustillante. Je vous promet rien, la Chimay est plus en promo à Carrefour (l'a-t-elle déjà été).
</p>
...
<div style="text-align: justify;">
    Notre idée est quelque peu différente à un <b>BadUSB</b> conventionnel:
    <ul>
...
<div style="display: flex; align-items: flex-start;">
    ...
    <div style="flex: 1;">
        <img src="../../assets/img/usb/duck_buy.gif" alt="">
    </div>
</div>
